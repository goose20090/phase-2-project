...
function ClickableTroubleshooter({className}){
    ...
    <div className={className}>
        ...
        <p className = {'fade-out'}id = "troubleshoot-content"> 
            ...
            Have a look at our <Link to= "/suggestions">Suggested Charcters List</Link> or the the <a href="https://lotr.fandom.com/wiki/Main_Page">Lord of the Rings Wiki</a> to confirm the correct spelling.
        </p>
    </div>
)}
